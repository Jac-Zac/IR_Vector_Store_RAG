...
qa = RetrievalQA.from_chain_type(llm=chat, chain_type="stuff", retriever=CustomRetriever(docsearch.as_retriever(search_kwargs={"k": 2})), chain_type_kwargs={"prompt": PROMPT,"memory":memory })
"""
